...
#### S.4.3 As a user, I want to be able to login on to the service, so that I can re-use my saved information
...
- Design a payment page to show after confirming the booking
